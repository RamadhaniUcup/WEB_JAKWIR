...
export async function updateKrediturProfile(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    if (namaPerusahaan !== undefined) dataUpdate.namaPerusahaan = namaPerusahaan;
    ...
    const updated = await prisma.kreditur.update({
      where: { idKreditur: idKreditur as number },
      data: dataUpdate,
    });
...
export async function getMyKrediturProfile(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const idKreditur = req.user?.idKreditur;
    if (!idKreditur) {
...
export async function getAspeks(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const idKreditur = req.user?.idKreditur;
    if (!idKreditur) {
...
export async function createAspek(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const idKreditur = req.user?.idKreditur;
    if (!idKreditur) {
      res.status(403).json({ message: "Forbidden." });
    ...
    const newAspek = await prisma.aspek.create({
      data: {
        idKreditur: idKreditur as number,
        namaAspek,
...
export async function updateAspek(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const exists = await prisma.aspek.findFirst({
      where: { idAspek, idKreditur: idKreditur as number }
    });
    if (!exists) {
    ...
    const { namaAspek, persentaseCf, persentaseSf, bobotAspek } = req.body;
    const dataUpdate: any = {};
    if (namaAspek !== undefined) dataUpdate.namaAspek = namaAspek;
    ...
    if (bobotAspek !== undefined) dataUpdate.bobotAspek = Number(bobotAspek);
...
export async function deleteAspek(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const idAspek = Number(req.params.id);
    const idKreditur = req.user?.idKreditur;
    if (!idKreditur) {
...
export async function getKriterias(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const list = await prisma.kriteria.findMany({
      where: {
        aspek: { idKreditur: idKreditur as number },
      },
...
export async function createKriteria(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const aspek = await prisma.aspek.findFirst({
      where: { idAspek: Number(idAspek), idKreditur: idKreditur as number }
    });
    if (!aspek) {
...
export async function updateKriteria(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const exists = await prisma.kriteria.findFirst({
      where: { idKriteria, aspek: { idKreditur: idKreditur as number } },
    });
...
export async function createSubKriteria(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const kriteria = await prisma.kriteria.findFirst({
      where: { idKriteria: Number(idKriteria), aspek: { idKreditur: idKreditur as number } },
    });
...
export async function updateSubKriteria(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const exists = await prisma.subKriteria.findFirst({
      where: { idSub, kriteria: { aspek: { idKreditur: idKreditur as number } } },
    });

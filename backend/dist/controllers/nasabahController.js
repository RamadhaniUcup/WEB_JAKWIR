 ...
 */
export async function getNasabahProfile(req, res) {
    try {
 ...
 */
export async function updateNasabahProfile(req, res) {
    try {
        const idNasabah = req.user?.id;
        if (!idNasabah) {
            res.status(401).json({ message: "Unauthorized. Pengguna tidak teridentifikasi." });
        ...
        if (namaNasabah !== undefined)
            updateData.namaNasabah = namaNasabah;
...
//# sourceMappingURL=nasabahController.js.map